...
if DEFINED APPVEYOR (
    ...
    if DEFINED CMAKE_INSTALL_PREFIX set CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT=0
...
echo INFO: CUDA_ARCH_BIN              = !CUDA_ARCH_BIN!
echo INFO: CUDA_ARCH_PTX              = !CUDA_ARCH_PTX!
...
cmake -G"!CMAKE_GENERATOR!" ^
      ...
      -DCMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT:BOOL=!CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT! ^
      -DCMAKE_INSTALL_PREFIX:PATH=!CMAKE_INSTALL_PREFIX! ^
      "-DCUDA_ARCH_BIN:STRING=!CUDA_ARCH_BIN!" ^
      -DCUDA_ARCH_PTX:STRING=!CUDA_ARCH_PTX! ^
      "%~dp0\.."
